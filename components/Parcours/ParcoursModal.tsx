...
interface ParcoursItem {
  ...
  description: string;
  ressources: string;
  categories: { _id: string; designation: string; slug: string; description: string }[];
  questions: number;
  image?: string;
  slug: string;
  status: string;
          ...
          >
            ...
            {step === 1 && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-medium text-black dark:text-white">Ressource</label>
                  <input
                    type="text"
